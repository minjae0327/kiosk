...
document.addEventListener('DOMContentLoaded', function() {
    ...
    payButton.addEventListener('click', function (event) {
        if (calculateTotalPrice() === 0) {
            ...
            packagingButton.addEventListener('click', function () {
                ...
                handlePackaging(totalPrice, packagingPreference, orderDetails);
            });
    ...
    function handlePackaging(totalPrice, packagingPreference, orderDetails) {
...
function getOrderDetails() {
    ...
    orderSections.forEach(orderSection => {
        ...
        if (menuNameElement && countElement) {
            ...
            let count = parseInt(countElement.innerText);
            orderDetails.push({ menuName, price, count });
        }
    });
